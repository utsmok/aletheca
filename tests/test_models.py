...
from syntheca.models import Work, Author, Source, Institution, Topic, Publisher, Funder
from syntheca.models import Meta, ApiResponse, SafeList, SafeStr
...
def test_safe_str_coerces_none():
    ...
    from syntheca.models.safe_types import SafeStr
    class M(BaseModel):
        name: SafeStr = ""
...
def test_safe_list_coerces_none():
    ...
    from syntheca.models.safe_types import SafeList
    class M(BaseModel):
