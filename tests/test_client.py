...
def test_explicit_auth_strategy_override():
    ...
    client = SynthecaClient(api_key="test-key", auth_strategy=NoAuth())
    assert isinstance(client._auth_strategy, NoAuth)
